<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\laragon\www\sticky\public/../application/admin\view\bis\detail.html";i:1561710838;s:73:"D:\laragon\www\sticky\public/../application/admin\view\public\header.html";i:1561009508;s:73:"D:\laragon\www\sticky\public/../application/admin\view\public\footer.html";i:1560923367;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-2">
				...
				<select name="city_id" class="select cityId">
					...
					<option value="<?php echo $vo['id']; ?>"<?php if($bisData['city_id'] == $vo['id']): ?> selected <?php endif; ?>><?php echo $vo['name']; ?></option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <img style="display: none" id="upload_org_code_img_other" src="<?php echo $bisData['licence_logo']; ?>" width="150" height="150">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text" value="<?php echo $bisData['person_tel']; ?>" placeholder="" id="" name="person_tel">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3"> <span class="select-box">
				<select name="category_id" class="select categoryId">
					...
					<option value="<?php echo $vo['id']; ?>" <?php if($locationData['category_id'] == $vo['id']): ?> selected <?php endif; ?>><?php echo $vo['name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
				</span>
            </div>
