<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\laragon\www\sticky\public/../application/admin\view\featured\index.html";i:1562052246;s:73:"D:\laragon\www\sticky\public/../application/admin\view\public\header.html";i:1562048442;s:73:"D:\laragon\www\sticky\public/../application/admin\view\public\footer.html";i:1562048410;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
  ...
  <form method="get" action="<?php echo url('featured/index'); ?>">
      ...
      <div class="formControls col-xs-8 col-sm-3"> <span class="select-box">
        <select name="type" class="select">
          ...
          <option value="<?php echo $key; ?>" <?php if($key == $typeVal): ?> selected <?php endif; ?>><?php echo $vo; ?></option>
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <tbody>
        ...
        <tr class="text-c">
          ...
          <td class="td-manage">
            <a style="text-decoration:none" onclick="o2o_del('<?php echo url('featured/status',['id'=>$vo['id'],'status'=>-1]); ?>')" class="ml-5" onClick="" href="javascript:;" title="删除">
